...
const { extractPublic, generate } = process.env.NODE_ENV == 'test' ?
  // @ts-ignore
  require('../../key/build/Release') :
  __non_webpack_require__('../key/build/Release');
...
Key.references =
  { owner: { query: withRepository('selectActorById'), id: 'ownerId' } };
