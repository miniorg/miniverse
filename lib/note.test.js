...
describe('create', () => {
  test('creates and returns a note', async () => {
    ...
    expect((await repository.selectRecentStatusesIncludingExtensionsAndPersonsByUsernameAndNormalizedHost('attributed to', null))[0])
...
describe('fromParsedActivityStreams', () => {
  ...
  test('creates and returns note from ActivityStreams representation', async () => {
    ...
    expect((await repository.selectRecentStatusesIncludingExtensionsAndPersonsByUsernameAndNormalizedHost('被行動者', null))[0])
      .toHaveProperty('id', note.id);
