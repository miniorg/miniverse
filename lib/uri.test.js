...
import { encodeSegment, encodeAcctUserpart, normalizeHost } from './uri';
...
describe('selectSubclass', () => {
  test('selects remote account', async () => {
    ...
    await expect(uri.selectSubclass('https://ReMoTe.إختبار/'))
      .resolves
      .toHaveProperty(['publicKey', 'uri'], 'https://ReMoTe.إختبار/key');
  });
});
