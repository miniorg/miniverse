...
`
    ...
    expect(person).toHaveProperty(['account', 'inbox', 'uri', 'uri'], 'https://remote.xn--kgbechtv/@preferred%20username/inbox');
    expect(person).toHaveProperty(['account', 'publicKey', 'uri', 'uri'], 'https://remote.xn--kgbechtv/@preferred%20username#key');
    expect(person).toHaveProperty(['account', 'publicKey', 'publicKeyPem'], `-----BEGIN RSA PUBLIC KEY-----

