...
export default class Note extends Relation {
  ...
  static async create(repository, published, actor, content, { uri, inReplyToId = null, inReplyToUri = null, summary = null, hashtags, mentions } = {}) {
    const note = new this({
      repository,
      status: new Status({
        repository,
        published,
        actor,
        uri: uri ? new URI({ repository, uri, allocated: true }) : null
      }),
      inReplyToId,
      summary,
      content,
