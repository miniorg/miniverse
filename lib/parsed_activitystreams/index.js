...
export default class {
  ...
  async act(actor) {
    ...
    if (type.has('Announce')) {
      return Announce.fromParsedActivityStreams(this.repository, this, actor);
    }

    if (type.has('Create')) {
      return Create.fromParsedActivityStreams(this.repository, this, actor);
    }

    if (type.has('Delete')) {
      return Delete.fromParsedActivityStreams(this.repository, this, actor);
    }

    if (type.has('Follow')) {
      return Follow.fromParsedActivityStreams(this.repository, this, actor);
    }

    if (type.has('Like')) {
      return Like.fromParsedActivityStreams(this.repository, this, actor);
    }

    if (type.has('Undo')) {
      return Undo.fromParsedActivityStreams(this.repository, this, actor);
    }
