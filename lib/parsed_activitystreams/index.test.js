...
describe('act', () => {
  test('performs create activity', async () => {
    ...
    await testLoading({
      ...
      const note = await activity.act(actor);
      const properties = await note.get();

      expect(note).toBeInstanceOf(Note);
      expect(properties).toHaveProperty(['attributedTo', 'id'], actor.id);
  ...
  test('performs delete activity', async () => {
    ...
    await testLoading({
      ...
      await expect(activity.act(actor)).resolves.toBeInstanceOf(Delete);
  ...
  test('performs follow activity', async () => {
    ...
    await testLoading({
      ...
      const follow = await activity.act(actor);
...
describe('create', () => {
  test('creates note', async () => {
    ...
    await testLoading({
      ...
      const note = await object.create(attributedTo);
      const properties = await note.get();
