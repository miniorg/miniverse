...
describe('act', () => {
  test('resolves known URI', async () => {
    ...
    await expect(activity.act(status.person))
      .resolves
  ...
  test('performs delete activity', async () => {
    ...
    await testLoading({
      ...
      await expect(activity.act(note.status.person)).resolves.toBe(null);
  ...
  test('performs follow activity', async () => {
    ...
    }, () => expect(activity.act(person)).resolves.toBe(null));
  });
  ...
  test('performs undo activity', async () => {
    ...
    await testLoading({
      ...
      await expect(activity.act(actor.person)).resolves.toBe(null);
